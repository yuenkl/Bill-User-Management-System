...
internal class OfflineFirstUserRepository(
    ...
    override fun observeUndoableDeletions(): Flow<List<UndoableDeletion>> = localDataSource.observeUndoableUsers()
    ...
    override suspend fun undoDelete(localId: String): Result<Unit> =
        durableOperation {
