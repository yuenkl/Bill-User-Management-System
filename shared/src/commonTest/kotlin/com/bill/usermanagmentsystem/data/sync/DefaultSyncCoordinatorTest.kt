...
class DefaultSyncCoordinatorTest {
    @Test
    fun overlappingTriggersJoinOneRemoteRunWithoutQueuedSecondSync() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun connectivityLossStopsBeforeNextFifoMutation() =
        runTest {
            val fixture = fixture()
            fixture.local.dueMutations +=
                listOf(
    ...
    @Test
    fun mutationsRunFifoBeforeOneSnapshotRequest() =
        runTest {
            val fixture = fixture()
            fixture.local.dueMutations +=
                listOf(
    ...
    @Test
    fun nextSyncRetriesOnlyAuthenticationBlockedMutationsAfterCredentialsChange() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun successfulSyncStartsAtFirstPageAndLoadsFollowingPagesInOrder() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun refreshResetsTheNextPageCursorFromTheInitialResponse() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun failedPageLoadDoesNotAdvanceTheCursor() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun pageLoadingWaitsForActiveSyncAndUsesItsPublishedCursor() =
        runTest {
            val fixture = fixture()
            val fetchStarted = CompletableDeferred<Unit>()
            val releaseFetch = CompletableDeferred<Unit>()
    ...
    @Test
    fun retryableCreatePersistsBackoffAndStopsFifoProcessing() =
        runTest {
    ...
    @Test
    fun authenticationFailureBlocksMutationWithoutAutomaticLoop() =
        runTest {
            val fixture = fixture()
            ...
            assertEquals(
                "blocked",
                fixture.local.blockedMutations
                    .single()
                    .first,
            )
            assertEquals(0, fixture.remote.fetchCalls)
    ...
    @Test
    fun validationFailureRemovesCreateIntentAndStillRefreshesSnapshot() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun permanentCreateFailureIsBlockedAndDoesNotLoop() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun deleteSuccessAndNotFoundBothCompleteDurableMutation() =
        runTest {
    ...
    @Test
    fun deleteWithoutRemoteIdCompletesLocallyWithoutNetwork() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun permanentDeleteFailureRestoresUserAndSurfacesReason() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun retryableDeleteFailureKeepsDurableMutationScheduled() =
        runTest {
            val fixture = fixture(now = 1_000)
            fixture.local.dueMutations +=
                dueDelete(
    ...
    @Test
    fun authenticationDeleteFailureRestoresUserAndRemovesAutomaticRetry() =
        runTest {
            val fixture = fixture()
            fixture.local.dueMutations +=
                dueDelete(
    ...
    @Test
    fun emptyRemoteSnapshotIsCommittedAfterOutboxDrains() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun permanentSnapshotFailureKeepsLocalSnapshotUntouched() =
        runTest {
            val fixture = fixture()
    ...
    @Test
    fun offlineRunStillFinalizesExpiredLocalDeletesBeforeStopping() =
        runTest {
